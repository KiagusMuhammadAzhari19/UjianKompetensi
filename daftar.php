...
<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 bg-white border-bottom shadow fixed-top ">
    ...
    <nav class="my-2 my-md-0 mr-md-3">
      ...
      <a class="p-2 text-dark" href="tampil/tampil.php">Tampil</a>
    </nav>
  </div>
  ...
  <script>
    ...
    let PilihanBeasiswa = "<div class='row'><label for='beasiswa' class='col-sm-3 col-form-label'>Pilih Beasiswa</label><div class='col-sm-9'><select class='form-control' id='beasiswa' name='beasiswa' required><option value=''>Pilih</option><option value='Beasiswa YBM PLN'>Beasiswa YBM PLN</option><option value='Beasiswa Bank Indonesia'>Beasiswa Bank Indonesia</option><option value='Beasiswa BAZNAZ'>Beasiswa BAZNAZ</option></select></div></div>";
