    ...
    <div style="margin-top: 5rem;">
      <form action="#" method="POST" name="pendaftaran">
        ...
        <div class="row">
          ...
          <div class="col-sm-9">
            <img src ="FileUpload/<?php echo $data->file ?>" width="200px" height="200px">
          </div>
        </div>
        <br>  
        <div class="row">
          <label for="status_ajuan" class="col-sm-3 col-form-label">Status</label>
          <div class="col-sm-9">
            <input type="text" value="<?php echo $data->status_ajuan ?>" id="status_ajuan" name="status_ajuan" required readonly>
          </div>
        </div>
